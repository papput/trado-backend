 ...
 */
export const getPendingExchanges = async (req: Request, res: Response) => {
  try {
 ...
 * @access Private (Admin)
 */
export const approveExchange = async (req: Request, res: Response) => {
  try {
    ...
    const debitAmount = (transaction as any).cryptoAmount || 0;
    const creditAmount = receivedAmount || (transaction as any).receivedAmount || 0;
