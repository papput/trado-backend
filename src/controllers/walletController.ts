...
export const deleteWalletAddress = async (req: Request, res: Response) => {
  try {
    const { id } = req.params
...
// Add wallet address
export const addWalletAddress = async (req: Request, res: Response) => {
  try {
...
export const getWalletAddressByNetwork = async (req: Request, res: Response) => {
  try {
